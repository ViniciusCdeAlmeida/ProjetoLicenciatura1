...
%Titulo
\title[\sc{Static Analisys}]{\textbf{Caracterização do Uso de Construções da Linguagem Java em Projetos Open-Source}}
...
\date[04/03/2016]{14 de julho de 2016}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% CENÁRIO %%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{frame}
		\frametitle{Cenário}
		\begin{itemize}
			\item Características adicionadas ao longo do tempo raramente removidas.
			
			\item Aumento na complexidade dificulta o aprendizado de novos programadores.

			
			\item Projetitas de linguagens não tem estratégia de alertar os desenvolvedores de contruções ultrapassadas.
			

			\item Alternância entre versões da linguagem no mesmo projeto.
			%Dialetos da linguagem. alternância entre versões atuais e versoes antigas da linguagem
			
			\item Dificuldade evoluir, testar e refatorar.
			
			\item Congelamento de código devido a restrições técnicas.
			%Banco de dados ou alguma outra caracteristica do sistema
		\end{itemize}
