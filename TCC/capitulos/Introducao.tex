...
%	O principal objetivo deste trabalho é analisar a adoção de construções da linguagem de programação  	Java em projetos \textit{open-source}, com o intuito de compreender a forma típica de utilização das construções 
	%da linguagem e verificar a adoção ou não das \textiti{caracter\'{i}sticas} presentes nas vers\~{o}es 
