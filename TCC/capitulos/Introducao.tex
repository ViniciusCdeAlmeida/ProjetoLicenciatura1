...
\section{Objetivos}
	...
	\begin{itemize}
	  ...
	  \item contrastar os resultados das análises com trabalhos de pesquisa recentemente publicados, 
	  mas que possivelmente não analisam todas as construções de interesse deste trabalho, em particular 
	  a ado\c{c}\~{a}o de constru\c{c}\~{o}es recentes na linguagem (como Express\~{o}es Lambda).
	  
	  \item identificar oportunidade de emprego para \texttt{multicatch}.
	  
	  \item identificar alguns casos espec\'{i}ficos, \textit{filter}, \textit{exists} e \textit{map}, para sugerir a ado\c{c}\~{a}o de Express\~{o}es Lambda.
	\end{itemize}
