...
Com isso a representação intermediária deste analisador é o processamento do código fonte para converte-lo em um \textit{parser} para que os  \textit{visitor} realizem sua pesquisa.
...
Sendo mais preciso ainda na representa\c c\~{a}o intermedi\'{a}ria, para cada arquivo fonte o analisador
