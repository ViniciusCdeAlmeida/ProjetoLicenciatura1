...
comando, o caminho para o arquivo \acs{CSV} criado na Seção \ref{subsec:entradaAS} o qual contém informações relevante s sobre os projetos. Após ser informado o arquivo de entrada é gerada uma lista que contém todos os projetos a serem analisados (ver Linha 19 no Figura:~\ref{lst:programaPrincipal}). 
