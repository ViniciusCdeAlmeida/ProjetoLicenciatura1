\chapter{Resultados}
Neste capítulo caracteriza como foi a adoção de construções da linguagem Java, o que pode vir a orientar desenvolvedores a compreender a melhor forma de aplicar algumas desta construções.

A contribuição desta monografia aborda dois marcos da linguagem \textit{Java Generics} e \textit{Lambda Expression} onde a questão de pesquisa para abordar esses assuntos é \textbf{RQ1:} Qual o típico uso de Java Generics e Java Lambda Expressions? 

A adoção de \textit{Java Generics} em projetos opensource através da replicação e extensão de um estudo de Parnin et al~\cite{Parnin:ACM2011}. Diferenciando do trabalho original este trabalho visa a compreensão de como a adoção de \textit{Java Generics} se correlaciona com a data de lançamento inicial dos projetos selecionados. 
E como os desenvolvedores usam \textit{Java Lambda Expression} e para o melhor conhecimento não há estudo empírico que investigou tal questão.
