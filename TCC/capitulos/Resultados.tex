...
Ou seja, a partir de milhares de casos de testes unitários no \textit{Hibernate}, apenas poucos testes para uma biblioteca específica (relacionados com \textit{cache}) usam \textit{Java Lambda Expression}. Este pequeno uso de \textit{Java Lambda Expression} pode ser principalmente motivado por uma decisão estratégica do projeto para evitar a migração do código fonte ultrapassado para a versão mais atual.
