...
No total de 64.179.440 \textbf{LOC} analisados o uso de \textit{multicatchs} em todas as \textit{releases} dos projeto representou somente 0,008\% do total de \textbf{LOC}, na relação do total de \textbf{trys} encontrados 563153, os \textit{multicatchs} representão 10315, ou seja, 1,83\% do total. \\

Diante desses dados\\ 10315 563153
