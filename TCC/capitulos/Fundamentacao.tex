...
%Em primeira vers\~{a}o, Java 1, existiam oito pacotes b\'{a}sicos, \texttt{java.lang}, \texttt{java.io}, \texttt{java.util}, \texttt{java.net}, \texttt{java.awt}, \texttt{java.awt.image}, \texttt{java.awt.peer} e \texttt{java.applet}. Este pacotes possibilitaram a ado\c{c}\~{a}o da linguagem Java no desenvolvimento de ferramentas populares da \'{e}poca como Netscape 3.0 e o Internet Explorer 3.0.  
...
%Dando um destaque para \textit{Generics} que \'{e} um dos objetos de estudo deste trabalho, \textit{Generics} trouxe a possibilidade especificar classes e/ou m\'{e}todos para serem utilizados com um prop\'{o}sito geral. Anterior a Java 5 uma lista poderia ser composta de diversos tipos e na recupera\c{c}\~{a}o era necess\'{a}rio o \textit{casting} de tipo para recuperar os objetos, os erros propenso eram somente neste estilo de programa\c{c}\~{a}o eram detectatos somente em tempo de execu\c{c}\~{a}o. 


%\begin{lstlisting}[caption={Exemplo de Listas antes de Generics - Java 5}\label{lst:exemploAntesGenerics},language=Java] 
%//Adicionando objetos a collection
...
%Neste mesmo exemplo Generics permitiu que as listas fosse mais especializadas declarndo seu tipo na inicializa\c{c}\~{a}o e com isso aceitaria somente o tipo declarado. Com isso um erro seria detectado durante a compila\c{c}\~{a}o, tornando o c\'{o}digo menos propenso a erros e desnecess\'{a}rio realizar casting de tipo na recupera\c{c}\~{a}o.

%\begin{lstlisting}[caption={Exemplo de Listas com Generics - Java 5}\label{lst:exemploAposGenerics},language=Java] 
%//Adicionando objetos a collection
